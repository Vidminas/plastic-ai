...
const { createDynamoDocumentClient, createDynamoConnector } = require('@librechat/api');
...
const tableName = process.env.DYNAMODB_TABLE || DEFAULT_DYNAMO_TABLE;
...
const connectDb = createDynamoConnector(client, tableName, logger);
const methods = createDynamoCoreMethods(client, { tableName, getCache: getLogStores });
